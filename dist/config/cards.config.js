...
exports.CARDS_CONFIG = void 0;
const conditions_1 = require("../backend/utils/conditions");
exports.CARDS_CONFIG = {
    HIT: {
        id: 'HIT',
        name: 'Удар',
        ...
        actions: [
            {
                ...
                condition: conditions_1.conditions.IsTargetEnemy
            },
        ],
    },
    BLOCK: {
        ...
        actions: [
            {
                ...
                condition: (context) => conditions_1.conditions.isTargetAtDistance(context, 2)
            },
        ],
    },
    FENCING: {
        ...
        actions: [
            {
                ...
                condition: conditions_1.conditions.isTargetInCorner
            },
        ],
    },
    MUSCLE_FLEXING: {
